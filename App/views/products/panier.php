...
<div class="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
    <div class="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
        <div class="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
            ...
            <div class=" bg-gray-50  w-full h-[600px] xl:w-[28rem] flex justify-between items-center md:items-start px-2 py-4 md:p-4 xl:p-8 flex-col">
                ...
                <div class="flex flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0">
                    ...
                    <form method="POST" action="<?php echo URLROOT; ?>/Commandes/addCommande">
                        <input type="hidden" name="prixCmd" value="" id="prixCmd">
                    <div class="flex xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                        <div class="flex justify-center md:justify-start xl:flex-col flex-col md:space-x-6 lg:space-x-8 xl:space-x-0 space-y-4 xl:space-y-12 md:space-y-0 md:flex-row items-center md:items-start">
                            <div class="flex justify-center md:justify-start items-center md:items-start flex-col space-y-4 xl:mt-4 w-full">
                                <p class="text-base  font-semibold leading-4 text-center md:text-left text-gray-800">Adresse de livraison</p>
                                <textarea type="text" name="adresse" class=" border border-black text-gray-900 text-sm  outline-none block w-full p-2  " placeholder="" required> </textarea>
                                <p class="text-base  font-semibold leading-4 text-center md:text-left text-gray-800">Phone</p>
                                <input type="text" name="tel" class=" border border-black text-gray-900 text-sm  outline-none block w-full p-2  " required>
                                <p class="text-base  font-semibold leading-4 text-center md:text-left text-gray-800">CIN</p>
                                <input type="text" name="cin" class=" border border-black text-gray-900 text-sm  outline-none block w-full p-2  " required>
                            </div>
                        </div>
                        <div class="flex w-full justify-center items-center md:justify-start md:items-start mt-8">

                            <button type="submit" class="uppercase w-4/5 text-base font-semibold text-white inline-block text-center bg-black border border-white py-3 hover:bg-gray-900 ">Commander</button>
                            <button type="submit" class="uppercase w-1/5 text-xl font-semibold inline-block text-center p-2.5 bg-white border border-black  hover:bg-gray-900 hover:text-white"><i class="fa-brands fa-paypal"></i></button>
                        </div>
                    </div>
                    </form>
                </div>
