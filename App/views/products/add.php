...
<main class="w-screen grid grid-cols-12 h-screen">
    ...
    <h2 class="uppercase text-4xl font-semibold my-10">Ajouter une produit</h2>
        <form class="w-full" method="POST" action="<?php echo URLROOT; ?>/produits/add" enctype="multipart/form-data">
            <div class="grid xl:grid-cols-2 xl:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" name="nom" id="nom" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-300 peer" value="<?php  echo $data['nom']?>" placeholder=" " ="">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    ...
                    <?php if(!empty($data['categorie'])): ?>
                        <option selected value="<?php  echo $data['categorie']?>"><?php  echo $data['categorie']?></option>
                    <?php else: ?>
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6">
                ...
                <select name="genre" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-gray-300 appearance-none  foutline-none  focus:border-blue-300 peer">
                    <?php if(!empty($data['genre'])): ?>
                        <option selected value="<?php  echo $data['genre']?>"><?php  echo $data['genre']?></option>
                    <?php else: ?>
                        <option selected value="">Genre de produit</option>
                    <?php endif ?>
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="model" name="model" id="model" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-300 peer" value="<?php  echo $data['model']?>" placeholder=" " ="">
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                    <input type="number" name="prix" id="prix" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300  outline-none focus:ring-0 focus:border-blue-300 peer" value="<?php  echo $data['prix']?>" placeholder=" " ="">
                ...
                <div class="relative z-0 w-full mb-10 group">
                    <input type="number" name="qteStock" id="qteStock" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-300 peer" value="<?php  echo $data['qteStock']?>" placeholder=" " ="">
            ...
            <div class="w-full">
                <div class="relative z-0 w-full mb-10 group">
                    <textarea type="text" name="description" id="description" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-300 peer" placeholder=" " =""></textarea>
            ...
            <button type="submit" name="addPrd" class="uppercase text-base font-semibold text-blue-300 inline-block text-center bg-black border border-white  px-20 py-3 hover:bg-gray-900 ">créer une produit</button>
        </form>
    </section>
</main>