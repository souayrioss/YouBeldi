...
<main class="snap-y snap-mandatory h-screen overflow-scroll">
        <section class="snap-start w-screen h-[620px] grid grid-cols-12 content-center items-center">
            <div class="col-start-3 col-end-8" >
                <h2 class="uppercase border-l-8 border-blue-300 px-5 text-9xl font-black">Nos engagements</h2>
            </div>
        </section>
        <section class="snap-start w-screen h-[620px] grid grid-cols-12 content-center items-center">
        ...
        <div class="snap-x snap-mandatory w-screen flex overflow-scroll ">
            <section class="snap-start flex-shrink-0 w-screen h-[620px] grid grid-cols-12 content-center items-center">
                <div class="col-start-3 col-end-12" >
                        <h2 class="uppercase border-l-8 border-blue-300 px-5 text-9xl font-black">Notres equipes</h2>
                </div>
            </section>
