...
<section class="mb-20">
    <div class="relative mb-10">
        ...
        <a href="client" class="absolute bottom-40 left-[740px] text-base font-bold text-white inline-block text-center border-2 border-white  px-10 py-3   hover:font-bold transition ">Femme</a>
    </div>
        <div class="w-full flex gap-5 justify-center items-center px-5 " id="trend-slider">
            ...
            <div><a href="ccccc"><img class="" src="<?php echo URLROOT ;?>/img/woman_2.webp" alt=""></a></div>
            ...
            <div><a><img class="h-80 w-[600px] " src="<?php echo URLROOT ;?>/img/woman_1.webp" alt=""></a></div>
...
<section class="mb-20">
    <div class="relative mb-10">
        ...
        <div class="w-full flex gap-5 justify-center items-center px-5" id="trend-slider">
            ...
            <div><a><img class="h-80 w-[600px] " src="<?php echo URLROOT ;?>/img/man_1.webp" alt=""></a></div>
